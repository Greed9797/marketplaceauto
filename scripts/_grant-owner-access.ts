 ...
 *
 * Run: ./node_modules/.bin/tsx scripts/_grant-owner-access.ts
 */
...
async function main() {
  ...
  // Create the new user only if missing. If it already exists we leave its
  // password and profile untouched (we were told it does not exist yet).
